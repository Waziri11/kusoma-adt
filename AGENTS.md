...
**Kusoma** — Hiki ni kitabu cha Kusoma cha mwanafunzi wa Kundirika la Kwanza Mwaka wa Kwanza kilichoandaliwa na Taasisi ya Elimu Tanzania, hivyo asili yake ni Tanzania na kimeandikwa kwa Kiswahili. Kinalenga wanafunzi wa ngazi ya mwanzo wa elimu ya msingi, hasa watoto au wanafunzi walio nje ya mfumo rasmi wanaojifunza stadi za awali za kusoma. Maudhui yake yanahusu kuzungumza, kutambua sauti za herufi na herufi mwambatano, kuunda silabi na maneno, kusoma kwa ufahamu na kwa ufasaha, kwa kutumia picha, nyimbo, hadithi, maswali na mazoezi mengi. Kwa jumla, kitabu kinafuata mbinu ya kujifunza hatua kwa hatua huku kikisisitiza maadili, usalama, ushirikiano na ujifunzaji wa vitendo.
...
```
Kusoma--la-PB-Kundirika-1-Mwaka-1-FINALE/
├── adt/                              # THE WEB APP
...
├── Kusoma--la-PB-Kundirika-1-Mwaka-1-FINALE.db                    # SQLite database (pipeline state)
├── Kusoma--la-PB-Kundirika-1-Mwaka-1-FINALE.pdf                   # Original source PDF
...
{
  "pg001_gp001_tx001": "",
  "pg001_im001": "Cheti cha ithibati cha Wizara ya Elimu, Sayansi na Teknolojia kwa kitabu cha Kusoma cha Mwanafunzi Kundirika la Kwanza Mwaka wa Kwanza, Na. 527, kilichoidhinishwa tarehe 13 Juni 2021 na kusainiwa na Kamishna wa Elimu Dkt. Lyabwene M. Mtahabwa.",
  "gl001": "adabu",
  "gl001_def": "Tabia ya heshima na upole kwa wengine."
}
```
...
```json
{
  "adabu": {
    "word": "adabu",
    "definition": "Tabia ya heshima na upole kwa wengine.",
    "variations": ["kwa adabu"],
    "emoji": "🙏🙂"
  }
}
```
...
| Original PDF | `Kusoma--la-PB-Kundirika-1-Mwaka-1-FINALE.pdf` |
| Pipeline database | `Kusoma--la-PB-Kundirika-1-Mwaka-1-FINALE.db` (SQLite) |
